...
@DiscriminatorValue("SUBAREA")
public class SubAreaAttribute extends AttributeEntity<Object> {

    @ManyToOne
    @JoinColumn(name = "sub_area_id", nullable = false)
    private SubArea subArea;

    @Override
    public SubArea getEntity() {
        return subArea;
    }
}
